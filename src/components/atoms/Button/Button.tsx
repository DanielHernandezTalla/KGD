...
const Button = ({
  ...
  const rootClassName = clsx(
    'cursor-pointer flex items-center font-medium transition-colors gap-3 outline-none',
    {
      ...
      'rounded-lg': !rounded,
      'w-full': fullWidth,
      'bg-blue-600 text-white hover:bg-blue-800': variant === 'primary',
      'bg-blue-100/50 text-blue-600 hover:bg-blue-100': variant === 'secondary',
      'bg-transparent text-blue-600 hover:bg-blue-100/50 border-2 border-gray-200': variant === 'outline',
      'bg-transparent text-blue-600 hover:bg-blue-100/50': variant === 'transparent',
